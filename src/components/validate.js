export class FormValidator {
  ...
  _validateForm (evt) {
    const msgSpan = this._form.querySelector(`.${evt.target.name}-invalid`);
...
export { FormValidator, enableValidation, toggleSubmitBtn };
*/
